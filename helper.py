...
def main():
    ...
    es = Elasticsearch(
        "https://my-elasticsearch-project-f689af.es.us-east-1.aws.elastic.cloud:443",
        api_key="SWZ6VnNaY0IxNm11YXV3SDRUaHg6OVN3ZDdwdVM5T29odDRYdTI4TTVEdw=="
    )
    
    # Initialize search system
    search_system = ProductSearchSystem(
        es_client=es,
        openai_api_key="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",
    ...
    test_queries = [
        ...
        # "Best rated Laptop under $1000",
        # "Can you show me good phones to buy"
        # "Can you show me good laptop to purchase"
        "I want to gift toy to my son, Can you show me some awsome product to give"
    ...
    for query in test_queries:
        ...
        # Perform search
        results = search_system.search_products(query)
        
        # Format and display results
        formatted_results = search_system.format_results_with_llm(results, query)
